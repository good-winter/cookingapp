...
INSERT IGNORE INTO diet_modes (code, label, sort_order) VALUES
  ('normal',     '正常人',   1),
  ('vegetarian', '素食主义', 2);

INSERT IGNORE INTO crowds (code, label, sort_order) VALUES
  ('pregnant', '孕妇',     1),
  ('student',  '学生',     2),
  ('fitness',  '健身人群', 3),
  ('elderly',  '老人',     4),
...
INSERT IGNORE INTO avoid_foods (code, label, sort_order) VALUES
  ('pork',     '猪肉', 1),
  ('beef',     '牛肉', 2),
  ('seafood',  '海鲜', 3),
  ('cilantro', '香菜', 4),
...
INSERT IGNORE INTO users (id, nickname, avatar_text, timezone) VALUES
  ('u_1', '美食家',   '美', 'Asia/Shanghai'),
  ('u_2', '健身狂人B', '健', 'Asia/Shanghai'),
  ('u_3', '厨房小白C', '厨', 'Asia/Shanghai');

INSERT IGNORE INTO user_preferences (user_id, diet_mode) VALUES
  ('u_1', 'normal'),
  ('u_2', 'normal'),
  ('u_3', 'normal');

INSERT IGNORE INTO user_preference_crowds (user_id, crowd) VALUES
  ('u_2', 'fitness'),
  ('u_3', 'student');

-- 开发期 token。多个 token 是为了让前端能验证关注流（关注是用户之间的动作）。
INSERT IGNORE INTO api_tokens (token, user_id) VALUES
...
INSERT IGNORE INTO recipe_crowds (recipe_id, crowd) VALUES
...
INSERT IGNORE INTO recipe_avoid_tags (recipe_id, avoid_tag) VALUES
  ('r_02', 'pork'),
...
INSERT IGNORE INTO posts (id, author_id, content, image_emoji, like_count, comment_count, created_at) VALUES
  ('p_01', 'u_2',
...
INSERT IGNORE INTO follows (follower_id, followee_id) VALUES ('u_1', 'u_2');
